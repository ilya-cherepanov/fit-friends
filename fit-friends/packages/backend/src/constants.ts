...
export const FRIEND_ALREADY_EXISTS = 'The friend already exists!';
export const BALANCE_CANNOT_BE_NEGATIVE = 'The balance cannot be negative!';
export const USERS_BALANCE_IS_ZERO = 'The user\'s balance is zero!';
export const USER_NOT_READY_FOR_TRAINING = 'The user is not ready for training!';
export const TRAINING_REQUEST_ALREADY_EXISTS = 'The training request already exists!';
export const NO_TRAINING_REQUEST = 'There is no training request!';
export const NO_SELF_TRAINING_REQUEST = 'The user cannot send a training request to himself!';
export const INVALID_TRAINING_REQUEST_STATUS = 'Invalid training request status!';
export const FAILED_CHANGE_TRAINING_REQUEST = 'Failed to change the status of the training request!';
