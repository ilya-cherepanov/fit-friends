              ...
              <ul className="special-offers__list">
                <li className="special-offers__item is-active">
                  <aside className="promo-slider">
                    ...
                    <div className="promo-slider__image"><img src="img/content/promo-1.png"
                                                              srcSet="img/content/promo-1@2x.png 2x" width="1040"
                                                              height="469" alt="promo-photo">
                    </div>
                ...
                <li className="special-offers__item">
                  <aside className="promo-slider">
                    <div className="promo-slider__overlay"></div>
                    <div className="promo-slider__image"><img src="img/content/promo-2.png"
                                                              srcSet="img/content/promo-2@2x.png 2x" width="1040"
                                                              height="469" alt="promo-photo">
                    </div>
                    <div className="promo-slider__header">
                ...
                <li className="special-offers__item">
                  <aside className="promo-slider">
                    <div className="promo-slider__overlay"></div>
                    <div className="promo-slider__image"><img src="img/content/promo-3.png"
                                                              srcSet="img/content/promo-3@2x.png 2x" width="1040"
                                                              height="469" alt="promo-photo">
                    </div>
                    <div className="promo-slider__header">
                      ...
                      <div className="thumbnail-training__image">
                        <picture>
                          <source type="image/webp"
                            ...
                            <img src="img/content/thumbnails/training-11.jpg"
                      ...
                      <div className="thumbnail-training__image">
                        <picture>
                          <source type="image/webp"
                            ...
                            <img src="img/content/thumbnails/training-09.jpg"
                    ...
                    <div className="thumbnail-user__image">
                      <picture>
                        <source type="image/webp"
                          ...
                          <img src="img/content/thumbnails/user-04.jpg"
                    ...
                    <div className="thumbnail-user__image">
                      <picture>
                        <source type="image/webp"
                          ...
                          <img src="img/content/thumbnails/user-05.jpg"
                    ...
                    <div className="thumbnail-user__image">
                      <picture>
                        <source type="image/webp"
                          ...
                          <img src="img/content/thumbnails/user-06.jpg"
                    ...
                    <div className="thumbnail-user__image">
                      <picture>
                        <source type="image/webp"
                          ...
                          <img src="img/content/thumbnails/user-07.jpg"
